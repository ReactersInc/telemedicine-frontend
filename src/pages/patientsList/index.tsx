...
function PatientsList() {
  ...
  const [projectedData, setProjectedData] = useState<Record[]>([]);

  const [timeStamps, setTimeStamps] = useState([]);
  const [selectedTimeStamp, setSelectedTimeStamp] = useState(0);
  
  const [timeStamps2, setTimeStamps2] = useState([]);
  const [selectedTimeStamp2, setSelectedTimeStamp2] = useState(0);
  ...
  const [showPatientVitals, setShowPatientVitals] = useState(false);
  const [showProjectedVitals, setShowProjectedVitals] = useState(false);
  ...
  const digitaltwin = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Add first 5 values to projectedData
        setProjectedData(valueObjects.slice(0, 5));
        setTimeStamps2(keysObjects.slice(0, 5));
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (jsonResponse && jsonResponse.Status) {
          ...
          const records = jsonResponse.Status.record;
          let timeStamps = records.map(
            (record: { timestamp: any }) => record.timestamp
          );
          setPatientData(records);
  ...
  useEffect(() => {
    console.log("useeffect called for doctor data");
  ...
  useEffect(() => {
    console.log("useeffect called for patient details");
                  ...
                  <td className="border-b-2 p-2 text-center">
                    <div className="flex justify-center gap-2">
                      <button
                        className="w-24"
                        onClick={() => {
                          setShowPatientVitals((prevState) => !prevState);
                          setShowProjectedVitals((prevState) => !prevState);
                        }}
                        >
                        View Vitals
                      </button>
              ...
              <div>
                ...
                <select
                  onChange={(e) => {
                    ...
                    setSelectedTimeStamp(parseInt(e.target.value));
                    console.log(e.target.value);
                  }}
                >
                  <option value={0}>{timeStamps[0]}</option>
                  <option value={1}>{timeStamps[1]}</option>
                  <option value={2}>{timeStamps[2]}</option>
                  <option value={3}>{timeStamps[3]}</option>
                  <option value={4}>{timeStamps[4]}</option>
                </select>
              </div>
            </div>
                  ...
                  <div className="row-vitals">
                    ...
                    <div className="Progress">
                      <div className="Circle-vitals">
                        <div> Heart Rate</div>
                        <div className="Label-vitals">{patientData[0].pulse}</div>
                    ...
                    <div className="Progress ">
                      <div className="Circle-vitals shadow-lg shadow-[#2cda6d] rounded-3xl ">
                        <div> SpO2</div>
                        <div className="Label-vitals-center">{patientData[0].SpO2}</div>
                        <Circle
                          percent={SpO2}
                          strokeWidth={7}
                          strokeColor="#25D366"
                  ...
                  <div className="row-vitals">
                    <div className="Progress">
                      <div className="Circle-vitals">
                        ...
                        <Circle
                          percent={
                            ((patientData[0].room_temp - 15) * 100) / (30 - 15) > 100
                              ? 100
                              : ((patientData[0].room_temp - 15) * 100) / (30 - 15)
                          }
                          strokeWidth={5}
                          strokeColor="#25D366"
                          trailWidth={5}
                    ...
                    <div className="progress">
                      <div className="Circle-vitals">
                        ...
                        <div className="Label-vitals">
                          ...
                          <div>{patientData[0].body_temp}°C</div>
                        </div>
                    ...
                    <div className="progress">
                      <div className="row-vitals">
                        ...
                        <div className="progress">
                          ...
                          <div className="Circle-vitals">
                            <div> Humidity</div>
                            <div className="Label-vitals">{patientData[0].humidity}</div>
                          ...
                          <div className="progress mt-8">
                            <div className="Circle-vitals">
                              <div> GSR</div>
                              <div className="Label-vitals">{patientData[0].gsr}</div>
                              ...
                              <div className="row-vitals ">
                                <div className="Progress ">
                                  <div className="Circle-vitals" id="sys">
                                    <div> Systolic</div>
                                    <div className="Label-vitals">{patientData[0].sys}</div>
                                ...
                                <div className="Progress ">
                                  <div className="Circle-vitals" id="dia">
                                    <div> Diastolic</div>
                                    <div className="Label-vitals">{patientData[0].dia}</div>
